...
{
    public class T_PS_PROJECT_STRUCT_DRAFT : BaseEntity
    {
        ...
        private T_PS_PROJECT_STRUCT_DRAFT _Parent;
        public virtual T_PS_PROJECT_STRUCT_DRAFT Parent
        {
            get
            {
                try
        ...
        private T_MD_CURRENCY _Currency;
        public virtual T_MD_CURRENCY Currency
        {
            get
            {
                try
