...
namespace SMO.Areas.MD.Controllers
{
    ...
    {
        private PurchaseTypeService _service;

        public PurchaseTypeController()
        {
            _service = new PurchaseTypeService();
        }
        ...
        public ActionResult List(PurchaseTypeService service)
        {
            service.Search();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(PurchaseTypeService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(PurchaseTypeService service)
        {
            var result = new TransferObject();
            result.Type = TransferType.AlertSuccessAndJsCommand;
            service.Update();
