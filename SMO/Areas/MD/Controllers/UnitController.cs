...
namespace SMO.Areas.MD.Controllers
{
    ...
    public class UnitController : Controller
    {
        ...
        public ActionResult ExportExcel()
        {
            ...
            var path = Server.MapPath("~/TemplateExcel/DanhSachDVT.xlsx");
            _service.ExportExcel(ref outFileStream, path);
            if (!_service.State)
            {
                return Content(_service.ErrorMessage);
            }
            return File(outFileStream.ToArray(), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "DanhSachDVT.xlsx");
        }
