...
namespace SMO.Areas.MD.Controllers
{
    ...
    public class ActionWorkflowController : Controller
    {
        private ActionWorkflowService _service;

        public ActionWorkflowController()
        {
            _service = new ActionWorkflowService();
        }
        ...
        public ActionResult List(ActionWorkflowService service)
        {
            service.Search();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(ActionWorkflowService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(ActionWorkflowService service)
        {
            var result = new TransferObject();
            result.Type = TransferType.AlertSuccessAndJsCommand;
            service.Update();
