...
namespace SMO.Areas.MD.Controllers
{
    ...
    public class TransmodeController : Controller
    {
        private TransmodeService _service;

        public TransmodeController()
        {
            _service = new TransmodeService();
        }
        ...
        public ActionResult List(TransmodeService service)
        {
            service.Search();
