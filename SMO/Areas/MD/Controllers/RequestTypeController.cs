...
namespace SMO.Areas.MD.Controllers
{
    ...
    {
        private RequestTypeService _service;

        public RequestTypeController()
        {
            _service = new RequestTypeService();
        }
        ...
        public ActionResult List(RequestTypeService service)
        {
            service.Search();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(RequestTypeService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(RequestTypeService service)
        {
            var result = new TransferObject();
            result.Type = TransferType.AlertSuccessAndJsCommand;
            service.Update();
