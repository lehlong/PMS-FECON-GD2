...
{
    [AuthorizeCustom(Right = "R2.10")]

    public class ProjectLevelController : Controller
    {
        private ProjectLevelService _service;

        public ProjectLevelController()
        {
            _service = new ProjectLevelService();
        }
        ...
        public ActionResult List(ProjectLevelService service)
        {
            service.Search();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(ProjectLevelService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(ProjectLevelService service)
        {
            var result = new TransferObject();
            result.Type = TransferType.AlertSuccessAndJsCommand;
            service.Update();
