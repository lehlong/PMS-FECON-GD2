...
namespace SMO.Areas.MD.Controllers
{
    ...
    public class ProjectTypeController : Controller
    {
        ...
        public ActionResult List(ProjectTypeService service)
        {
            service.Search();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(ProjectTypeService service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Update(ProjectTypeService service)
        {
            var result = new TransferObject();
            result.Type = TransferType.AlertSuccessAndJsCommand;
            service.Update();
