...
{
    public class T_PS_PROJECT_STRUCT_DRAFT_Map : BaseMapping<T_PS_PROJECT_STRUCT_DRAFT>
    {
        public T_PS_PROJECT_STRUCT_DRAFT_Map()
        {
            ...
            References(x => x.Currency).Columns("CURRENCY").Not.Insert().Not.Update().LazyLoad();
