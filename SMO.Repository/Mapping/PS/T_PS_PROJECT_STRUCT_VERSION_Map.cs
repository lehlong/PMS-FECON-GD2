...
{
    public class T_PS_PROJECT_STRUCT_VERSION_Map : BaseMapping<T_PS_PROJECT_STRUCT_VERSION>
    {
        public T_PS_PROJECT_STRUCT_VERSION_Map()
        {
            Id(x => x.PKID).GeneratedBy.Assigned();
            Map(x => x.ID).Not.Update();
